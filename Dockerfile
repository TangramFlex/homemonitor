...
ARG INCOMING_MESSAGE_SET_NAME=oldalarm
ARG OUTGOING_MESSAGE_SET_NAME=newalarm
ARG TRANSFORM_NAME=OldToNewTransform

WORKDIR /app

RUN apt-cache update && apt install -y g++ make python3 python3-dev python3-pip pkg-config curl \
